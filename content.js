  ...
  async function showLauncher() {
    ...
    shadow.innerHTML = `
      ...
      <div class="scrim"></div><section class="card" role="dialog" aria-modal="true" aria-labelledby="cc-launch-title"><div class="content">
        <header class="top"><strong class="brand">REPLICA <span class="version">— V0.7.3</span></strong><button class="icon close" aria-label="Close"><svg viewBox="0 0 24 24"><path d="m6 6 12 12M18 6 6 18"/></svg></button></header>
        ...
        <details class="recipe"><summary>Build recipe <small>Local only</small></summary><div class="recipe-body"><label class="row"><span>Target</span><select data-pref="target"><option>React</option><option>Next.js</option><option>Vue</option><option>HTML</option></select></label><label class="row"><span>Styling</span><select data-pref="styling"><option>Tailwind CSS</option><option>CSS Modules</option><option>Plain CSS</option><option>Styled Components</option></select></label><label class="row"><span>Output</span><select data-pref="mode"><option>UI + behavior</option><option>Visual UI only</option><option>Behavior only</option></select></label></div></details><p class="privacy">● &nbsp; Processed locally on this device</p><a href="https://ko-fi.com/A5W826JCDD" target="_blank" rel="noopener noreferrer" aria-label="Support Replica on Ko-fi" style="width:max-content;display:block;margin:10px auto 0;border-radius:9px;line-height:0"><img src="${chrome.runtime.getURL("kofi-button.png")}" alt="Buy Me a Coffee at Ko-fi.com" style="height:28px;display:block;border:0;border-radius:7px;outline:1px solid rgba(255,255,255,.1)"></a>
      </div></section>`;
  ...
  function showPromptCard(data, preferences) {
    ...
    shadow.innerHTML = `
      ...
      <div class="scrim"></div><section class="card" role="dialog" aria-modal="true" aria-labelledby="cc-title"><div class="content">
        ...
        <div class="actions"><button class="again">Capture another</button><button class="download">Download JSON</button></div><p class="status">Processed locally on this device</p><a href="https://ko-fi.com/A5W826JCDD" target="_blank" rel="noopener noreferrer" aria-label="Support Replica on Ko-fi" style="width:max-content;display:block;margin:8px auto 0;border-radius:9px;line-height:0"><img src="${chrome.runtime.getURL("kofi-button.png")}" alt="Buy Me a Coffee at Ko-fi.com" style="height:28px;display:block;border:0;border-radius:7px;outline:1px solid rgba(255,255,255,.1)"></a>
      </div></section>`;
    document.documentElement.append(host);
