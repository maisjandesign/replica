...
function render() {
  ...
  captureMeta.textContent = `${capture.summary.width} × ${capture.summary.height}px · ${capture.summary.nodes} nodes · ${capture.summary.interactive} interactive`;
